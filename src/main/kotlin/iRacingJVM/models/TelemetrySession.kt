...
class TelemetrySession(
    ...
    @JsonProperty("DriverInfo")val driverInfo: DriverInfo,
    @JsonProperty("CarSetup") val carSetup: CarSetup,
)

data class DriverInfo(
    @JsonProperty("DriverCarIdx")val driverCarIdx: Int,
    @JsonProperty("DriverUserID")val driverUserId: Int,
    @JsonProperty("PaceCarIdx")val paceCarIdx: Int,
    @JsonProperty("DriverHeadPosX")val driverHeadPosX: Double,
    @JsonProperty("DriverHeadPosY")val driverHeadPosY: Double,
    @JsonProperty("DriverHeadPosZ")val driverHeadPosZ: Double,
    @JsonProperty("DriverCarIdleRPM")val driverCarIdleRPM: Double,
    @JsonProperty("DriverCarRedLine")val driverCarRedLine: Double,
    @JsonProperty("DriverCarEngCylinderCount")val driverCarEngCylinderCount: Int,
    @JsonProperty("DriverCarFuelKgPerLtr")val driverCarFuelKgPerLtr: Double,
    @JsonProperty("DriverCarFuelMaxLtr")val driverCarFuelMaxLtr: Double,
    @JsonProperty("DriverCarMaxFuelPct")val driverCarMaxFuelPct: Double,
    @JsonProperty("DriverCarSLFirstRPM")val driverCarSLFirstRPM: Double,
    @JsonProperty("DriverCarSLShiftRPM")val driverCarSLShiftRPM: Double,
    @JsonProperty("DriverCarSLLastRPM")val driverCarSLLastRPM: Double,
    @JsonProperty("DriverCarSLBlinkRPM")val driverCarSLBlinkRPM: Double,
    @JsonProperty("DriverCarVersion")val driverCarVersion: String,
    @JsonProperty("DriverPitTrkPct")val driverPitTrkPct: Double,
    @JsonProperty("DriverCarEstLapTime")val driverCarEstLapTime: Double,
    @JsonProperty("DriverSetupName")val driverSetupName: String,
    @JsonProperty("DriverSetupIsModified")@JsonFormat(shape = JsonFormat.Shape.NUMBER)val driverSetupIsModified: Boolean,
    @JsonProperty("DriverSetupLoadTypeName")val driverSetupLoadTypeName: String,
    @JsonProperty("DriverSetupPassedTech")@JsonFormat(shape = JsonFormat.Shape.NUMBER)val driverSetupPassedTech: Boolean,
    @JsonProperty("DriverIncidentCount")val driverIncidentCount: Int,
    @JsonProperty("Drivers")val drivers: List<Driver>,
)

data class Driver(
    @JsonProperty("CarIdx")val carIdx: Int,
    @JsonProperty("UserName")val userName: String,
    @JsonProperty("AbbrevName")val abbrevName: String?,
    @JsonProperty("Initials")val initials: String?,
    ...
    @JsonProperty("CarNumberRaw")val carNumberRaw: Int,
    @JsonProperty("CarPath")val carPath: String,
    @JsonProperty("CarClassID")val carClassId: Int,
    @JsonProperty("CarID")val carId: Int,
    @JsonProperty("CarIsPaceCar")@JsonFormat(shape = JsonFormat.Shape.NUMBER)val carIsPaceCar: Boolean,
    @JsonProperty("CarIsAI")@JsonFormat(shape = JsonFormat.Shape.NUMBER)val carIsAI: Boolean,
    @JsonProperty("CarScreenName")val carScreenName: String,
    @JsonProperty("CarScreenNameShort")val carScreenNameShort: String,
    @JsonProperty("CarClassShortName")val carClassShortName: String,
    @JsonProperty("CarClassRelSpeed")val carClassRelSpeed: Int,
    @JsonProperty("CarClassLicenseLevel")val carClassLicenseLevel: Int,
    @JsonProperty("CarClassMaxFuelPct")val carClassMaxFuelPct: String,
    @JsonProperty("CarClassWeightPenalty")val carClassWeightPenalty: String,
    @JsonProperty("CarClassPowerAdjust")val carClassPowerAdjust: String,
    @JsonProperty("CarClassDryTireSetLimit")val carClassDryTireSetLimit: String,
    @JsonProperty("CarClassColor")val carClassColor: String,
    @JsonProperty("IRating")val iRating: Int,
    @JsonProperty("LicLevel")val licLevel: Int,
    @JsonProperty("LicSubLevel")val licSubLevel: Int,
    @JsonProperty("LicString")val licString: String,
    @JsonProperty("LicColor")val licColor: String,
    @JsonProperty("IsSpectator")@JsonFormat(shape = JsonFormat.Shape.NUMBER)val isSpectator: Boolean,
    @JsonProperty("CarDesignStr")val carDesignStr: String,
    @JsonProperty("HelmetDesignStr")val helmetDesignStr: String,
    @JsonProperty("SuitDesignStr")val suitDesignStr: String,
    @JsonProperty("CarNumberDesignStr")val carNumberDesignStr: String,
    @JsonProperty("CarSponsor_1")val carSponsor1: Int,
    @JsonProperty("CarSponsor_2")val carSponsor2: Int,
    @JsonProperty("ClubName")val clubName: String,
    @JsonProperty("DivisionName")val divisionName: String,
    @JsonProperty("CurDriverIncidentCount")val curDriverIncidentCount: Int,
    @JsonProperty("TeamIncidentCount")val teamIncidentCount: Int,
)
